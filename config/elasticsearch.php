...
if ($data_from_env = parse_url(env('ELASTICSEARCH_URL'))) {
    putenv('ELASTICSEARCH_HOST='.@$data_from_env['host']);
    putenv('ELASTICSEARCH_PORT='.@$data_from_env['port']);
    putenv('ELASTICSEARCH_SCHEME='.@$data_from_env['scheme']);
    putenv('ELASTICSEARCH_USER='.@$data_from_env['user']);
    putenv('ELASTICSEARCH_PASS='.@$data_from_env['pass']);
}
